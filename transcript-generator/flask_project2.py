...
def transcripts_in_range(range_of_roll):
    ...
    for  roll in input_roll_list:
        ...
        o.Visible = False
        wb_path = "C:\\Users\\rsvin\\OneDrive\\Desktop\\Harika\\proj2\\output\\"+roll+".xlsx"
        wb = o.Workbooks.Open(wb_path)
        ws_index_list = [1] #say you want to print these sheets
        path_to_pdf = "C:\\Users\\rsvin\\OneDrive\\Desktop\\Harika\\proj2\\TranscriptsIITP\\"+ roll+".pdf"
...
def transcripts_all():
    ...
    for  roll in names_data:
        ...
        wb = o.Workbooks.Open(wb_path)
        ws_index_list = [1] #say you want to print these sheets
        path_to_pdf = "C:\\Users\\rsvin\\OneDrive\\Desktop\\Harika\\proj2\\Transcriptsall\\"+ roll+".pdf"
        for index in ws_index_list:
            ws = wb.Worksheets[index - 1]
            ws.PageSetup.Zoom = False
            ws.PageSetup.paperSize = 8
